...
public class Lexer {
    ...
    private final Set<String> keywords = Set.of("programa_minipar", "SEQ", "PAR", "if", "else", "while", "c_channel", "send", "receive", "input", "print");
    ...
    private void initPatterns() {
        ...
        patterns.put(Pattern.compile("^[+\\-*/=<>!]=?|^==|^!="), TokenType.OPERATOR);
